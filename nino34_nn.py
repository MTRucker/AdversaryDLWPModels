...
def train(model, curr_optimizer, use_device, curr_loader, weights_list, epoch):
    ...
    for batch_id, (data, target, anom) in enumerate(curr_loader):
        ...
        if batch_id % 100 == 0:
            ...
            th.save(network.state_dict(), f'./results/tau_{tau_to_use}_adamw/{current_adam_model}_nino34_model.pth')
            th.save(optimizer.state_dict(), f'./results/tau_{tau_to_use}_adamw/{current_adam_model}_nino34_optimizer.pth')
